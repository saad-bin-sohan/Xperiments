...
as String?,rescheduleCount: null == rescheduleCount ? _self.rescheduleCount : rescheduleCount // ignore: cast_nullable_to_non_nullable
as int,regretScore: freezed == regretScore ? _self.regretScore : regretScore // ignore: cast_nullable_to_non_nullable
as int?,surpriseScore: freezed == surpriseScore ? _self.surpriseScore : surpriseScore // ignore: cast_nullable_to_non_nullable
as int?,wouldRepeat: freezed == wouldRepeat ? _self.wouldRepeat : wouldRepeat // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String labId,  String name,  String? hypothesis,  String? motivation,  DateTime startDate,  ExperimentFrequency frequency,  List<int>? customDays,  bool isOpenEnded,  int? durationValue,  ExperimentDurationUnit? durationUnit,  DateTime? endDate,  ExperimentStatus status,  PassFailResult? passFailResult,  DateTime? pausedAt,  bool remindersEnabled,  String? reminderTime,  String? interferenceNote,  bool interferenceLogEnabled,  DateTime createdAt,  DateTime? completedAt,  String? finalReflection,  String? lessonsLearned,  String? skipReason,  int rescheduleCount,  int? regretScore,  int? surpriseScore,  bool? wouldRepeat,  List<ExperimentSubtask> subtasks,  List<PauseWindow> pauseHistory)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Experiment() when $default != null:
return $default(_that.id,_that.userId,_that.labId,_that.name,_that.hypothesis,_that.motivation,_that.startDate,_that.frequency,_that.customDays,_that.isOpenEnded,_that.durationValue,_that.durationUnit,_that.endDate,_that.status,_that.passFailResult,_that.pausedAt,_that.remindersEnabled,_that.reminderTime,_that.interferenceNote,_that.interferenceLogEnabled,_that.createdAt,_that.completedAt,_that.finalReflection,_that.lessonsLearned,_that.skipReason,_that.rescheduleCount,_that.regretScore,_that.surpriseScore,_that.wouldRepeat,_that.subtasks,_that.pauseHistory);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String labId,  String name,  String? hypothesis,  String? motivation,  DateTime startDate,  ExperimentFrequency frequency,  List<int>? customDays,  bool isOpenEnded,  int? durationValue,  ExperimentDurationUnit? durationUnit,  DateTime? endDate,  ExperimentStatus status,  PassFailResult? passFailResult,  DateTime? pausedAt,  bool remindersEnabled,  String? reminderTime,  String? interferenceNote,  bool interferenceLogEnabled,  DateTime createdAt,  DateTime? completedAt,  String? finalReflection,  String? lessonsLearned,  String? skipReason,  int rescheduleCount,  int? regretScore,  int? surpriseScore,  bool? wouldRepeat,  List<ExperimentSubtask> subtasks,  List<PauseWindow> pauseHistory)  $default,) {final _that = this;
switch (_that) {
case _Experiment():
return $default(_that.id,_that.userId,_that.labId,_that.name,_that.hypothesis,_that.motivation,_that.startDate,_that.frequency,_that.customDays,_that.isOpenEnded,_that.durationValue,_that.durationUnit,_that.endDate,_that.status,_that.passFailResult,_that.pausedAt,_that.remindersEnabled,_that.reminderTime,_that.interferenceNote,_that.interferenceLogEnabled,_that.createdAt,_that.completedAt,_that.finalReflection,_that.lessonsLearned,_that.skipReason,_that.rescheduleCount,_that.regretScore,_that.surpriseScore,_that.wouldRepeat,_that.subtasks,_that.pauseHistory);case _:
  throw StateError('Unexpected subclass');
...
@override@JsonKey() final  int rescheduleCount;
@override final  int? regretScore;
@override final  int? surpriseScore;
@override final  bool? wouldRepeat;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Experiment&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.labId, labId) || other.labId == labId)&&(identical(other.name, name) || other.name == name)&&(identical(other.hypothesis, hypothesis) || other.hypothesis == hypothesis)&&(identical(other.motivation, motivation) || other.motivation == motivation)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.frequency, frequency) || other.frequency == frequency)&&const DeepCollectionEquality().equals(other._customDays, _customDays)&&(identical(other.isOpenEnded, isOpenEnded) || other.isOpenEnded == isOpenEnded)&&(identical(other.durationValue, durationValue) || other.durationValue == durationValue)&&(identical(other.durationUnit, durationUnit) || other.durationUnit == durationUnit)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.status, status) || other.status == status)&&(identical(other.passFailResult, passFailResult) || other.passFailResult == passFailResult)&&(identical(other.pausedAt, pausedAt) || other.pausedAt == pausedAt)&&(identical(other.remindersEnabled, remindersEnabled) || other.remindersEnabled == remindersEnabled)&&(identical(other.reminderTime, reminderTime) || other.reminderTime == reminderTime)&&(identical(other.interferenceNote, interferenceNote) || other.interferenceNote == interferenceNote)&&(identical(other.interferenceLogEnabled, interferenceLogEnabled) || other.interferenceLogEnabled == interferenceLogEnabled)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.completedAt, completedAt) || other.completedAt == completedAt)&&(identical(other.finalReflection, finalReflection) || other.finalReflection == finalReflection)&&(identical(other.lessonsLearned, lessonsLearned) || other.lessonsLearned == lessonsLearned)&&(identical(other.skipReason, skipReason) || other.skipReason == skipReason)&&(identical(other.rescheduleCount, rescheduleCount) || other.rescheduleCount == rescheduleCount)&&(identical(other.regretScore, regretScore) || other.regretScore == regretScore)&&(identical(other.surpriseScore, surpriseScore) || other.surpriseScore == surpriseScore)&&(identical(other.wouldRepeat, wouldRepeat) || other.wouldRepeat == wouldRepeat)&&const DeepCollectionEquality().equals(other._subtasks, _subtasks)&&const DeepCollectionEquality().equals(other._pauseHistory, _pauseHistory));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,userId,labId,name,hypothesis,motivation,startDate,frequency,const DeepCollectionEquality().hash(_customDays),isOpenEnded,durationValue,durationUnit,endDate,status,passFailResult,pausedAt,remindersEnabled,reminderTime,interferenceNote,interferenceLogEnabled,createdAt,completedAt,finalReflection,lessonsLearned,skipReason,rescheduleCount,regretScore,surpriseScore,wouldRepeat,const DeepCollectionEquality().hash(_subtasks),const DeepCollectionEquality().hash(_pauseHistory)]);
